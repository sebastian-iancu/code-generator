...
h|*1..1*
|*openehr_id*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*external_id*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*status*: `<<_terminology_status_class,TERMINOLOGY_STATUS>>`
