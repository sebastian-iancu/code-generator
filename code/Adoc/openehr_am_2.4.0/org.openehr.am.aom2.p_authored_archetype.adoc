...
h|*Inherit*
2+|`link:/classes/P_ARCHETYPE[P_ARCHETYPE], link:/classes/AUTHORED_RESOURCE[AUTHORED_RESOURCE], link:/classes/P_AUTHORED_RESOURCE[P_AUTHORED_RESOURCE]`
...
h|*1..1*
|*build_uid*: `link:/classes/UID[UID]`
...
h|*1..1*
|*rm_release*: `link:/classes/String[String]`
...
h|*1..1*
|*is_generated*: `link:/classes/Boolean[Boolean]`
...
h|*1..1*
|*other_meta_data*: `link:/classes/Hash[Hash]<String,String>`
a|
|===
