...
h|*0..1*
|*archetype_data_value_parent_class*: `link:/classes/String[String]`
...
h|*0..1*
|*aom_rm_type_mappings*: `link:/classes/Hash[Hash]<String,AOM_TYPE_MAPPING>`
...
h|*0..1*
|*archetype_visualise_descendants_of*: `link:/classes/String[String]`
...
h|*0..1*
|*aom_rm_type_substitutions*: `link:/classes/Hash[Hash]<String,String>`
...
h|*0..1*
|*aom_lifecycle_mappings*: `link:/classes/Hash[Hash]<String,String>`
...
h|*0..1*
|*rm_primitive_type_equivalences*: `link:/classes/Hash[Hash]<String,String>`
