...
h|*Inherit*
2+|`xref:AM:aom2:constraint_model_package.adoc#_c_ordered_class[C_ORDERED]`
...
h|*0..1*
|*pattern_constraint*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
(redefined)*
|*c_value_conforms_to* ( +
other: `xref:AM:aom2:constraint_model_package.adoc#_c_ordered_class[C_ORDERED][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
