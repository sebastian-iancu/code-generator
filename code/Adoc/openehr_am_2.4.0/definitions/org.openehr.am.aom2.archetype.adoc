...
h|*1..1*
|*definition*: `link:/releases/AM/{am_release}/aom14.html#_c_complex_object_class[C_COMPLEX_OBJECT^]`
...
h|*0..1*
|*rules*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{base_release}/expression.html#_statement_set_class[STATEMENT_SET^]>`
