...
h|*0..1*
|*component_terminologies*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:AM:aom2:persistence_package.adoc#_p_archetype_terminology_class[P_ARCHETYPE_TERMINOLOGY]>`
