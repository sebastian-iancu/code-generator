...
h|*0..1*
|*members*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom2:constraint_model_package.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT]>`
