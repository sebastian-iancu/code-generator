...
h|
|*required*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]{nbsp}={nbsp}0`
a|Data item is required to formally satisfy `_constraint_`.

Enumeration value = 0.

h|
|*extensible*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]{nbsp}={nbsp}1`
...
h|
|*preferred*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]{nbsp}={nbsp}2`
...
h|
|*example*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]{nbsp}={nbsp}3`
