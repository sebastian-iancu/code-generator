...
h|*0..1 +
(effected)*
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_date_class[Iso8601_date]>>`
