...
h|*0..1*
|*namespace*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Reverse domain name namespace identifier.

h|*1..1*
|*rm_publisher*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Name of the Reference Model publisher.

h|*1..1*
|*rm_package*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*rm_class*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Name of the root class of this archetype.

h|*1..1*
|*concept_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|The short concept name of the archetype as used in the multi-axial `_archetype_hrid_`.

h|*1..1*
|*release_version*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*build_count*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*semantic_id* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|The 'interface' form of the HRID, i.e. down to the major version.

h|*1..1*
|*physical_id* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|The 'physical' form of the HRID, i.e. with complete version information specified by `_version_id()_`.

h|*1..1*
|*version_id* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Full version identifier string, based on `_release_version_`, `_version_status_`, and `_build_count_` e.g. `"1.8.2-rc.4"`.

h|*1..1*
|*major_version* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Major version of this archetype, extracted from `_release_version_`.

h|*1..1*
|*minor_version* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Minor version of this archetype, extracted from `_release_version_`.

h|*1..1*
|*patch_version* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
