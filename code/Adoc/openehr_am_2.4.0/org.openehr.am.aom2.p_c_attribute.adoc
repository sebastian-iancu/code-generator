...
h|*Inherit*
2+|`link:/classes/P_ARCHETYPE_CONSTRAINT[P_ARCHETYPE_CONSTRAINT]`
...
h|*0..1*
|*existence*: `link:/classes/String[String]`
...
h|*0..**
|*children*: `link:/classes/List[List]<link:/classes/P_C_OBJECT[P_C_OBJECT]>`
...
h|*0..1*
|*cardinality*: `link:/classes/String[String]`
