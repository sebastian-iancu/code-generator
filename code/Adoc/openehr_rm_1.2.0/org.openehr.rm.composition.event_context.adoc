...
h|*Inherit*
2+|`link:/classes/PATHABLE[PATHABLE]`
...
h|*1..1*
|*start_time*: `link:/classes/DV_DATE_TIME[DV_DATE_TIME]`
...
h|*0..**
|*participations*: `link:/classes/List[List]<link:/classes/PARTICIPATION[PARTICIPATION]>`
