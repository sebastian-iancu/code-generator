...
h|*1..1*
|*numerator*: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
a|Numerator of ratio

h|*1..1*
|*denominator*: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
a|Denominator of ratio.

h|*1..1*
|*type*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
