...
h|*0..1*
|*accuracy_is_percent*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*0..1 +
(effected)*
|*accuracy*: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
...
h|*1..1*
|*valid_percentage* ( +
number: `xref:BASE:foundation_types:primitive_types_package.adoc#_ordered_numeric_class[Ordered_Numeric][1]` +
