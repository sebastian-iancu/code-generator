...
): `<<_terminology_access_class,TERMINOLOGY_ACCESS>>`
...
|*code_set* ( +
name: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^][1]` +
): `<<_code_set_access_class,CODE_SET_ACCESS>>` +
 +
...
h|*1..1*
|*openehr_code_sets* (): `link:/releases/BASE/{base_release}/foundation_types.html#_hash_class[Hash^]<String,String>`
