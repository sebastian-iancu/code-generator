...
h|*1..1*
|*scheme* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*fragment_id* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*query* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
