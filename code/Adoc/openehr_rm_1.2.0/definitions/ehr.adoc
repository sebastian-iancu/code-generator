...
h|*0..1*
|*folders*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
a|Optional additional Folder structures for this EHR. If set, the `_directory_` attribute refers to the first member.

h|*0..1*
|*tags*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
