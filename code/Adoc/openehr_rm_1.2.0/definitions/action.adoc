...
h|*1..1*
|*ism_transition*: `xref:RM:composition:content_package.adoc#_ism_transition_class[ISM_TRANSITION]`
a|Details of transition in the Instruction state machine caused by this Action.

h|*0..1*
|*instruction_details*: `xref:RM:composition:content_package.adoc#_instruction_details_class[INSTRUCTION_DETAILS]`
