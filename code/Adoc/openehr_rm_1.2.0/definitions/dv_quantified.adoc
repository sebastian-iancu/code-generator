...
h|*0..1*
|*magnitude_status*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*valid_magnitude_status* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
...
h|*1..1 +
(abstract)*
|*magnitude* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_ordered_numeric_class[Ordered_Numeric]`
a|

h|*1..1*
|*accuracy_unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
