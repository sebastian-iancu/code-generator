...
h|*0..1*
|*versions*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/RM/{rm_release}/common.html#_version_class[VERSION^]<<<_x_contribution_class,X_CONTRIBUTION>>>>`
