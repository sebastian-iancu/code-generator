...
h|*0..**
|*other_input_version_uids*: `link:/classes/List[List]<link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID]>`
...
h|*0..**
|*attestations*: `link:/classes/List[List]<link:/classes/ATTESTATION[ATTESTATION]>`
