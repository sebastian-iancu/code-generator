...
h|*1..**
|*items*: `link:/classes/List[List]<link:/classes/REVISION_HISTORY_ITEM[REVISION_HISTORY_ITEM]>`
...
h|*1..1*
|*most_recent_version* (): `link:/classes/String[String]` +
 +
__Post__: `Result.is_equal (items.last.version_id.value)`
a|The version id of the most recent item, as a String.

h|*1..1*
|*most_recent_version_time_committed* (): `link:/classes/String[String]` +
 +
