...
h|*1..1*
|*persist_in_server*: `link:/classes/Boolean[Boolean]`
a|If True, this Request is persisted in the server until further notice.

h|*0..1*
|*repeat_period*: `link:/classes/DV_DURATION[DV_DURATION]`
a|Period for resending update Extracts in response to original Request.

h|*0..**
|*trigger_events*: `link:/classes/List[List]<link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]>`
...
h|*1..1*
|*update_method*: `link:/classes/CODE_PHRASE[CODE_PHRASE]`
