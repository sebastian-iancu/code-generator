...
h|*Inherit*
2+|`link:/classes/DATA_VALUE[DATA_VALUE]`
...
h|*0..1*
|*hyperlink*: `link:/classes/DV_URI[DV_URI]`
...
h|*0..1*
|*formatting*: `link:/classes/String[String]`
...
h|*0..**
|*mappings*: `link:/classes/List[List]<link:/classes/TERM_MAPPING[TERM_MAPPING]>`
