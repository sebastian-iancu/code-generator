...
h|*Inherit*
2+|`link:/classes/OPENEHR_TERMINOLOGY_GROUP_IDENTIFIERS[OPENEHR_TERMINOLOGY_GROUP_IDENTIFIERS], link:/classes/OPENEHR_CODE_SET_IDENTIFIERS[OPENEHR_CODE_SET_IDENTIFIERS]`
h|*Functions*
^h|*Signature*
^h|*Meaning*
...
): `link:/classes/TERMINOLOGY_ACCESS[TERMINOLOGY_ACCESS]`
...
|*code_set* ( +
name: `link:/classes/String[String][1]` +
): `link:/classes/CODE_SET_ACCESS[CODE_SET_ACCESS]` +
 +
...
h|*1..**
|*terminology_identifiers* (): `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..1*
|*openehr_code_sets* (): `link:/classes/Hash[Hash]<String,String>`
a|Set of all code set identifiers known in the terminology service.

h|*1..**
|*code_set_identifiers* (): `link:/classes/List[List]<link:/classes/String[String]>`
