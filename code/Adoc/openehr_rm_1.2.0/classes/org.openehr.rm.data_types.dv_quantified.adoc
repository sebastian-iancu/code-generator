...
h|*0..1*
|*magnitude_status*: `link:/classes/String[String]`
...
h|*1..1 +
(abstract)*
|*magnitude* (): `link:/classes/Ordered_Numeric[Ordered_Numeric]`
a|

h|*1..1*
|*accuracy_unknown* (): `link:/classes/Boolean[Boolean]`
