...
h|*1..1*
|*time_committed*: `link:/classes/DV_DATE_TIME[DV_DATE_TIME]`
a|Time of committal of the item.

h|*1..1*
|*change_type*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
a|Type of change. Coded using the openEHR Terminology  audit change type  group.

h|*0..1*
|*description*: `link:/classes/DV_TEXT[DV_TEXT]`
...
h|*1..1*
|*committer*: `link:/classes/PARTY_PROXY[PARTY_PROXY]`
