...
h|*1..1*
|*current_state*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
a|The ISM current state. Coded by openEHR terminology group Instruction states.

h|*0..1*
|*transition*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
...
h|*0..1*
|*careflow_step*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
...
h|*0..**
|*reason*: `link:/classes/List[List]<link:/classes/DV_TEXT[DV_TEXT]>`
