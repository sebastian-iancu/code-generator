...
h|*0..**
|*chapters*: `link:/classes/List[List]<link:/classes/EXTRACT_CHAPTER[EXTRACT_CHAPTER]>`
a|The content extracted and serialised from the source repository for this Extract.

h|*0..1*
|*specification*: `link:/classes/EXTRACT_SPEC[EXTRACT_SPEC]`
...
h|*0..1*
|*request_id*: `link:/classes/HIER_OBJECT_ID[HIER_OBJECT_ID]`
...
h|*0..**
|*participations*: `link:/classes/List[List]<link:/classes/EXTRACT_PARTICIPATION[EXTRACT_PARTICIPATION]>`
