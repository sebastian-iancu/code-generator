...
h|*1..1*
|*contribution*: `link:/classes/OBJECT_REF[OBJECT_REF]`
a|Contribution in which this version was added.

h|*0..1*
|*signature*: `link:/classes/String[String]`
a|OpenPGP digital signature or digest of content committed in this Version.

h|*1..1*
|*commit_audit*: `link:/classes/AUDIT_DETAILS[AUDIT_DETAILS]`
...
h|*1..1*
|*is_branch* (): `link:/classes/Boolean[Boolean]`
