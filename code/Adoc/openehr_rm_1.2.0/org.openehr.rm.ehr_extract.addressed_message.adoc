...
h|*1..1*
|*sender*: `link:/classes/String[String]`
a|Party sending the message.

h|*1..1*
|*sender_reference*: `link:/classes/String[String]`
...
h|*1..**
|*addressees*: `link:/classes/List[List]<link:/classes/String[String]>`
a|Intended recipients, in the form of internet addresses.

h|*0..1*
|*urgency*: `link:/classes/Integer[Integer]`
...
h|*1..1*
|*message*: `link:/classes/MESSAGE[MESSAGE]`
