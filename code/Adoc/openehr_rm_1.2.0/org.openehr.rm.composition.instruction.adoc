...
h|*1..1*
|*narrative*: `link:/classes/DV_TEXT[DV_TEXT]`
a|Mandatory human-readable version of what the Instruction is about.

h|*0..1*
|*expiry_time*: `link:/classes/DV_DATE_TIME[DV_DATE_TIME]`
...
h|*0..1*
|*wf_definition*: `link:/classes/DV_PARSABLE[DV_PARSABLE]`
a|Optional workflow engine executable expression of the Instruction.

h|*0..**
|*activities*: `link:/classes/List[List]<link:/classes/ACTIVITY[ACTIVITY]>`
