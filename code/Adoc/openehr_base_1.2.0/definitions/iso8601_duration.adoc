...
h|*1..1*
|*to_seconds* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
...
h|*1..1*
|*multiply* __alias__ "&#42;" ( +
a_val: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real][1]` +
): `xref:BASE:foundation_types:time_types.adoc#_iso8601_duration_class[Iso8601_duration]`
