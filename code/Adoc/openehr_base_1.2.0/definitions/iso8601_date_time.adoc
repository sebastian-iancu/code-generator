...
h|*1..1*
|*year* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
a|Extract the year part of the date as an Integer.

h|*1..1*
|*month* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]` +
 +
__Pre__: `not month_unknown`
a|Extract the month part of the date/time as an Integer, or return 0 if not present.

h|*1..1*
|*day* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]` +
 +
__Pre__: `not day_unknown`
a|Extract the day part of the date/time as an Integer, or return 0 if not present.

h|*1..1*
|*hour* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]` +
 +
__Pre__: `not hour_unknown`
a|Extract the hour part of the date/time as an Integer, or return 0 if not present.

h|*1..1*
|*minute* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]` +
 +
__Pre__: `not minute_unknown`
a|Extract the minute part of the date/time as an Integer, or return 0 if not present.

h|*1..1*
|*second* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]` +
 +
...
h|*1..1*
|*fractional_second* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
...
h|*1..1*
|*month_unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Indicates whether month in year is unknown.

h|*1..1*
|*day_unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Indicates whether day in month is unknown.

h|*1..1*
|*minute_unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Indicates whether minute in hour is known.

h|*1..1*
|*second_unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Indicates whether minute in hour is known.

h|*1..1*
|*is_decimal_sign_comma* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this time has a decimal part indicated by `','` (comma) rather than `'.'` (period).

h|*1..1 +
(effected)*
|*is_partial* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this date time is partial, i.e. if seconds or more is missing.

h|*1..1 +
(effected)*
|*is_extended* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this date/time uses `'-'`, `':'` separators.

h|*1..1*
|*has_fractional_second* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if the `_fractional_second_` part is significant (i.e. even if = 0.0).

h|*1..1*
|*as_string* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
