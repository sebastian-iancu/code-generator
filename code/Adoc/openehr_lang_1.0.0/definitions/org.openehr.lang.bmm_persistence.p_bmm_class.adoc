...
h|*0..1*
|*properties*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,<<_p_bmm_property_class,P_BMM_PROPERTY>>>`
...
h|*0..1*
|*generic_parameter_defs*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,<<_p_bmm_generic_parameter_class,P_BMM_GENERIC_PARAMETER>>>`
...
h|*0..1*
|*ancestor_defs*: `link:/classes/List[List] <<<_p_bmm_generic_type_class,P_BMM_GENERIC_TYPE>>>`
