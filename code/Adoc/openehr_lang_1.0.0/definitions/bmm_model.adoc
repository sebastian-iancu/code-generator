...
h|*0..1*
|*class_definitions*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,link:/classes/BMM_CLASS[BMM_CLASS] >`
a|All classes in this model, keyed by type name.

h|*0..1*
|*used_models*: `link:/classes/List[List] <xref:LANG:bmm:core_package.adoc#_bmm_model_class[BMM_MODEL]>`
