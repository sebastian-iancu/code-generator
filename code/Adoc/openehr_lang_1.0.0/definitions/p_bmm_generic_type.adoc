...
h|*1..1*
|*root_type*: `link:/classes/String[String] `
a|Root type of this generic type, e.g. `Interval` in `Interval<Integer>`.

h|*1..1*
|*generic_parameter_defs*: `link:/classes/List[List] <xref:LANG:bmm_persistence_package.adoc#_p_bmm_type_class[P_BMM_TYPE]>`
...
h|*0..1*
|*generic_parameters*: `link:/classes/List[List] <link:/classes/String[String] >`
...
h|*0..1 +
(redefined)*
|*bmm_type*: `link:/classes/BMM_GENERIC_TYPE[BMM_GENERIC_TYPE] `
...
h|*0..1*
|*generic_parameter_refs* (): `link:/classes/List[List] <xref:LANG:bmm_persistence_package.adoc#_p_bmm_type_class[P_BMM_TYPE]>`
