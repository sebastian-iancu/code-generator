...
h|*0..1*
|*parameters*: `link:/classes/List[List] <<<_bmm_parameter_class,BMM_PARAMETER>>>`
a|Formal parameters of the routine.

h|*0..1*
|*locals*: `link:/classes/List[List] <<<_bmm_local_class,BMM_LOCAL>>>`
a|Local variables of the routine.

h|*0..1*
|*pre_conditions*: `link:/classes/List[List] <<<_bmm_assertion_class,BMM_ASSERTION>>>`
a|

h|*0..1*
|*post_conditions*: `link:/classes/List[List] <<<_bmm_assertion_class,BMM_ASSERTION>>>`
a|
