...
h|*Inherit*
2+|`xref:LANG:bmm_persistence_package.adoc#_p_bmm_package_container_class[P_BMM_PACKAGE_CONTAINER]`, `xref:LANG:bmm:model_access_package.adoc#_bmm_schema_class[BMM_SCHEMA]`
...
h|*0..1*
|*primitive_types*: `link:/classes/List[List] <xref:LANG:bmm_persistence_package.adoc#_p_bmm_class_class[P_BMM_CLASS]>`
a|Primitive type definitions. Persisted attribute.

h|*0..1*
|*class_definitions*: `link:/classes/List[List] <xref:LANG:bmm_persistence_package.adoc#_p_bmm_class_class[P_BMM_CLASS]>`
