...
h|*Inherit*
2+|`link:/classes/P_BMM_BASE_TYPE[P_BMM_BASE_TYPE]`
...
h|*1..**
|*generic_parameter_defs*: `link:/classes/List[List]<link:/classes/P_BMM_TYPE[P_BMM_TYPE]>`
...
h|*1..**
|*generic_parameter_refs* (): `link:/classes/List[List]<link:/classes/P_BMM_TYPE[P_BMM_TYPE]>`
