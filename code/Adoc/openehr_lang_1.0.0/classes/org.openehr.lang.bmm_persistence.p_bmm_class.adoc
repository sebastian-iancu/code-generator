...
h|*Inherit*
2+|`link:/classes/P_BMM_MODEL_ELEMENT[P_BMM_MODEL_ELEMENT]`
...
h|*0..1*
|*properties*: `link:/classes/Hash[Hash]<String,P_BMM_PROPERTY>`
...
h|*0..1*
|*generic_parameter_defs*: `link:/classes/Hash[Hash]<String,P_BMM_GENERIC_PARAMETER>`
...
h|*0..**
|*ancestor_defs*: `link:/classes/List[List]<link:/classes/P_BMM_GENERIC_TYPE[P_BMM_GENERIC_TYPE]>`
...
h|*1..1*
|*create_bmm_class* (): `link:/classes/void[void]`
