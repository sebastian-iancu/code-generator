...
h|*0..1*
|*details*: `link:/releases/BASE/{base_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{base_release}/foundation_types.html#_any_class[Any^],<<_resource_description_item_class,RESOURCE_DESCRIPTION_ITEM>>>`
