...
h|*0..1*
|*translations*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:overview.adoc#_any_class[Any],xref:BASE:resource:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>`
