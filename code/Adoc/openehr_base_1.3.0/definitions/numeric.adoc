...
(abstract)*
|*add* __alias__ "+" ( +
other: `xref:BASE:foundation_types:primitive_types_package.adoc#_numeric_class[Numeric][1]` +
...
h|*1..1 +
(abstract)*
|*negative* __alias__ "-" (): `xref:BASE:foundation_types:primitive_types_package.adoc#_numeric_class[Numeric]`
