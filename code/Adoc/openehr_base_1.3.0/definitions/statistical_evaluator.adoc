...
h|*1..1*
|*sum* ( +
vals: `xref:BASE:foundation_types:structure_types.adoc#_container_class[Container]<xref:BASE:foundation_types:primitive_types_package.adoc#_numeric_class[Numeric]>[1]` +
...
|*median* ( +
vals: `xref:BASE:foundation_types:structure_types.adoc#_container_class[Container]<xref:BASE:foundation_types:primitive_types_package.adoc#_numeric_class[Numeric]>[1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_numeric_class[Numeric]`
