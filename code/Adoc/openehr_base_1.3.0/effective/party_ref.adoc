...
|xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF].*namespace*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
...
|xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF].*type*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
...
|xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF].*id*: `xref:BASE:base_types:identification_package.adoc#_object_id_class[OBJECT_ID]` [1..1]
