...
h|*1..1*
|*timezone* (): `link:/classes/Iso8601_timezone[Iso8601_timezone]`
...
h|*1..1*
|*add* ( +
a_diff: `link:/classes/Iso8601_duration[Iso8601_duration][1]` +
): `link:/classes/Iso8601_date_time[Iso8601_date_time]`
...
h|*1..1*
|*diff* ( +
a_date_time: `link:/classes/Iso8601_date_time[Iso8601_date_time][1]` +
): `link:/classes/Iso8601_duration[Iso8601_duration]`
a|Difference of two date/times.

h|*1..1*
|*add_nominal* ( +
a_diff: `link:/classes/Iso8601_duration[Iso8601_duration][1]` +
): `link:/classes/Iso8601_date[Iso8601_date]`
