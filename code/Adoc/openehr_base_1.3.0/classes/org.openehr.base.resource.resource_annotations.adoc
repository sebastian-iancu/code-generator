...
h|*1..1*
|*documentation*: `link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<String,String>>>`
