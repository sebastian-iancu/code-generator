...
h|*1..1*
|*original_language*: `xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code]`
...
h|*0..1*
|*annotations*: `xref:BASE:resource_package.adoc#_resource_annotations_class[RESOURCE_ANNOTATIONS]`
...
h|*0..1*
|*translations*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>`
...
h|*1..1*
|*current_revision* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]` +
 +
