...
h|*1..1*
|*lower_unbounded*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|`lower` boundary open (i.e. = -infinity).

h|*1..1*
|*upper_unbounded*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|`upper` boundary open (i.e. = +infinity).

h|*1..1*
|*lower_included*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|`lower` boundary value included in range if not `lower_unbounded`.

h|*1..1*
|*upper_included*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*intersects* ( +
other: `xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
