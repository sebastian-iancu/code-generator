...
h|*Inherit*
2+|`link:/classes/AUDIT_DETAILS[AUDIT_DETAILS]`
...
h|*0..1*
|*attested_view*: `link:/classes/DV_MULTIMEDIA[DV_MULTIMEDIA]`
a|Optional visual representation of content attested e.g. screen image.

h|*0..1*
|*proof*: `link:/classes/String[String]`
a|Proof of attestation.

h|*0..**
|*items*: `link:/classes/List[List]<link:/classes/DV_EHR_URI[DV_EHR_URI]>`
...
h|*1..1*
|*is_pending*: `link:/classes/Boolean[Boolean]`
