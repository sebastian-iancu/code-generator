...
h|*1..1*
|*data*: `link:/releases/RM/{rm_release}/data_structures.html#_history_class[HISTORY^]<ITEM_STRUCTURE>`
a|The data of this observation, in the form of a history of values which may be of any complexity.

h|*0..1*
|*state*: `link:/releases/RM/{rm_release}/data_structures.html#_history_class[HISTORY^]<ITEM_STRUCTURE>`
