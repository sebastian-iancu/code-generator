...
h|*Inherit*
2+|`xref:RM:composition:content_package.adoc#_care_entry_class[CARE_ENTRY]`
...
h|*1..1*
|*data*: `xref:RM:data_structures:history_package.adoc#_history_class[HISTORY]<xref:RM:data_structures:item_structure_package.adoc#_item_structure_class[ITEM_STRUCTURE]>`
a|The data of this observation, in the form of a history of values which may be of any complexity.

h|*0..1*
|*state*: `xref:RM:data_structures:history_package.adoc#_history_class[HISTORY]<xref:RM:data_structures:item_structure_package.adoc#_item_structure_class[ITEM_STRUCTURE]>`
