...
h|*0..1*
|*normal_range*: `<<_dv_interval_class,DV_INTERVAL>><DV_PROPORTION>`
a|Optional normal range.

h|*0..**
|*other_reference_ranges*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<<<_reference_range_class,REFERENCE_RANGE>><DV_PROPORTION>>`
