...
h|*0..1*
|*data*: `xref:BASE:foundation_types:structure_types.adoc#_array_class[Array]<xref:BASE:foundation_types:primitive_types_package.adoc#_octet_class[Octet]>`
...
h|*0..1*
|*integrity_check*: `xref:BASE:foundation_types:structure_types.adoc#_array_class[Array]<xref:BASE:foundation_types:primitive_types_package.adoc#_octet_class[Octet]>`
