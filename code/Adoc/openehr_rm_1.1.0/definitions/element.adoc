...
h|*0..1*
|*null_reason*: `xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]`
...
h|*1..1*
|*is_null* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
