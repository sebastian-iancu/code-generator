...
h|*1..1*
|*magnitude*: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real]`
a|Numeric magnitude of the quantity.

h|*0..1*
|*precision*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
...
h|*1..1*
|*units*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*units_system*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*units_display_name*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
(redefined)*
|*multiply* __alias__ "&#42;" ( +
factor: `xref:BASE:foundation_types:primitive_types_package.adoc#_real_class[Real][1]` +
): `xref:RM:data_types:quantity_package.adoc#_dv_quantity_class[DV_QUANTITY]`
...
h|*1..1*
|*is_integral* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
