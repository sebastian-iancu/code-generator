...
h|*1..1*
|*match*: `xref:BASE:foundation_types:primitive_types_package.adoc#_character_class[Character]`
...
h|*1..1*
|*narrower* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
__Post__: `match = ‘<’ implies Result`
a|The mapping is to a narrower term.

h|*1..1*
|*broader* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
__Post__: `match = ‘>’ implies Result`
a|The mapping is to a broader term.

h|*1..1*
|*equivalent* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|The mapping is to an equivalent term.

h|*1..1*
|*unknown* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
__Post__: `match = ‘?’ implies Result`
...
h|*1..1*
|*is_valid_match_code* ( +
c: `xref:BASE:foundation_types:primitive_types_package.adoc#_character_class[Character][1]` +
