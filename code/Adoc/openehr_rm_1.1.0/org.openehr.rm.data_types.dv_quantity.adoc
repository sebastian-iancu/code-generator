...
h|*0..1*
|*units_system*: `link:/classes/String[String]`
...
h|*0..1*
|*units_display_name*: `link:/classes/String[String]`
...
h|*1..1*
|*add* ( +
other: `link:/classes/DV_QUANTITY[DV_QUANTITY][1]` +
): `link:/classes/DV_QUANTITY[DV_QUANTITY]`
