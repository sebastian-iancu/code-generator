...
h|*Inherit*
2+|`link:/classes/DATA_STRUCTURE[DATA_STRUCTURE]`
...
h|*0..1*
|*summary*: `link:/classes/ITEM_STRUCTURE[ITEM_STRUCTURE]`
...
h|*0..**
|*events*: `link:/classes/List[List]<link:/classes/EVENT[EVENT]<T>>`
