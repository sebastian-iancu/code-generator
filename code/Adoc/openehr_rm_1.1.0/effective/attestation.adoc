...
|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].*system_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
...
|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].*time_committed*: `xref:RM:data_types:quantity_package.adoc#_dv_date_time_class[DV_DATE_TIME]` [1..1]
a|Time of committal of the item.

|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].*change_type*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]` [1..1]
a|Type of change. Coded using the openEHR Terminology  audit change type  group.

|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].*description*: `xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]` [0..1]
...
|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].*committer*: `xref:RM:common:generic_package.adoc#_party_proxy_class[PARTY_PROXY]` [1..1]
...
2+a|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].__System_id_valid__: `not system_id.is_empty`

2+a|xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS].__Change_type_valid__: `terminology (Terminology_id_openehr).has_code_for_group_id (Group_id_audit_change_type, change_type.defining_code)`
