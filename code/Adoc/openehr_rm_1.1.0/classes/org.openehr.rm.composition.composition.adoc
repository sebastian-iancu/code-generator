...
h|*1..1*
|*language*: `link:/classes/CODE_PHRASE[CODE_PHRASE]`
...
h|*1..1*
|*territory*: `link:/classes/CODE_PHRASE[CODE_PHRASE]`
...
h|*1..1*
|*category*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
...
h|*0..**
|*content*: `link:/classes/List[List]<link:/classes/CONTENT_ITEM[CONTENT_ITEM]>`
...
h|*1..1*
|*is_persistent* (): `link:/classes/Boolean[Boolean]`
...
h|*Invariants*
2+a|__Setting_valid__: ``

h|
2+a|__unnamed2__: ``

h|
2+a|__unnamed3__: `Terminology (Terminology_id_openehr).has_code_for_group_id (Group_id_setting, setting.defining_code)`
