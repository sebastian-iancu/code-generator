...
h|*Inherit*
2+|`link:/classes/PROPORTION_KIND[PROPORTION_KIND], link:/classes/DV_AMOUNT[DV_AMOUNT]`
...
h|*1..1*
|*numerator*: `link:/classes/Real[Real]`
a|Numerator of ratio

h|*1..1*
|*denominator*: `link:/classes/Real[Real]`
a|Denominator of ratio.

h|*1..1*
|*type*: `link:/classes/Integer[Integer]`
...
h|*0..1*
|*normal_range*: `link:/classes/DV_INTERVAL[DV_INTERVAL]<DV_PROPORTION>`
a|Optional normal range.

h|*0..**
|*other_reference_ranges*: `link:/classes/List[List]<link:/classes/REFERENCE_RANGE[REFERENCE_RANGE]<DV_PROPORTION>>`
...
h|*1..1*
|*add* ( +
other: `link:/classes/DV_PROPORTION[DV_PROPORTION][1]` +
): `link:/classes/DV_PROPORTION[DV_PROPORTION]`
