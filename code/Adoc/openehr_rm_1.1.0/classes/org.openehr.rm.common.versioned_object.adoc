...
h|*1..1*
|*owner_id*: `link:/classes/OBJECT_REF[OBJECT_REF]`
...
h|*1..1*
|*version_count* (): `link:/classes/Integer[Integer]`
a|Return the total number of versions in this object.

h|*1..**
|*all_version_ids* (): `link:/classes/List[List]<link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID]>`
a|Return a list of ids of all versions in this object.

h|*1..**
|*all_versions* (): `link:/classes/List[List]<link:/classes/VERSION[VERSION]<T>>`
a|Return a list of all versions in this object.

h|*1..1*
|*has_version_at_time* ( +
a_time: `link:/classes/DV_DATE_TIME[DV_DATE_TIME][1]` +
): `link:/classes/Boolean[Boolean]`
a|True if a version for time  `_a_time_` exists.

h|*1..1*
|*has_version_id* ( +
a_version_uid: `link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID][1]` +
): `link:/classes/Boolean[Boolean]`
...
h|*1..1*
|*revision_history* (): `link:/classes/REVISION_HISTORY[REVISION_HISTORY]`
a|History of all audits and attestations in this versioned repository.

h|*1..1*
|*latest_version* (): `link:/classes/VERSION[VERSION]`
a|Return the most recently added version (i.e. on trunk or any branch).

h|*1..1*
|*latest_trunk_version* (): `link:/classes/VERSION[VERSION]`
a|Return the most recently added trunk version.

h|*1..1*
|*trunk_lifecycle_state* (): `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]` +
 +
...
a_contribution: `link:/classes/OBJECT_REF[OBJECT_REF][1]`, +
a_new_version_uid: `link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID][1]`, +
a_preceding_version_id: `link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID][1]`, +
an_audit: `link:/classes/AUDIT_DETAILS[AUDIT_DETAILS][1]`, +
a_lifecycle_state: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT][1]`, +
a_data: `T[1]`, +
signing_key: `link:/classes/String[String][1]` +
...
a_lifecycle_state: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT][1]`, +
a_data: `T[1]`, +
an_other_input_uids: `link:/classes/List[List]<link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID]>[1]`, +
signing_key: `link:/classes/String[String][1]` +
): `link:/classes/void[void]` +
 +
__Pre__: `all_version_ids.has (a_preceding_version_uid) or else version_count = 0`
...
a_contribution: `link:/classes/OBJECT_REF[OBJECT_REF][1]`, +
an_audit: `link:/classes/AUDIT_DETAILS[AUDIT_DETAILS][1]`, +
a_version: `link:/classes/ORIGINAL_VERSION[ORIGINAL_VERSION][1]` +
): `link:/classes/void[void]`
a|Add a new imported version. Details of version id etc come from the `ORIGINAL_VERSION` being committed.

h|*1..1*
|*commit_attestation* ( +
an_attestation: `link:/classes/ATTESTATION[ATTESTATION][1]`, +
a_ver_id: `link:/classes/OBJECT_VERSION_ID[OBJECT_VERSION_ID][1]`, +
signing_key: `link:/classes/String[String][1]` +
): `link:/classes/void[void]` +
 +
__Pre__: `has_version_id(a_ver_id)
