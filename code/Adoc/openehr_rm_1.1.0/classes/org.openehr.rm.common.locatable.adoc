...
h|*1..1*
|*name*: `link:/classes/DV_TEXT[DV_TEXT]`
...
h|*1..1*
|*archetype_node_id*: `link:/classes/String[String]`
...
h|*0..1*
|*uid*: `link:/classes/UID_BASED_ID[UID_BASED_ID]`
a|Optional globally unique object identifier for root points of archetyped structures.

h|*0..**
|*links*: `link:/classes/List[List]<link:/classes/LINK[LINK]>`
...
h|*0..1*
|*archetype_details*: `link:/classes/ARCHETYPED[ARCHETYPED]`
a|Details of archetyping used on this node.

h|*0..1*
|*feeder_audit*: `link:/classes/FEEDER_AUDIT[FEEDER_AUDIT]`
