...
h|*0..1*
|*item_type*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
a|Identifier of model or schema used to create the content.

h|*0..1*
|*item_type_version*: `link:/classes/String[String]`
a|Version of model or schema used to create the content item.

h|*0..1*
|*author*: `link:/classes/String[String]`
...
h|*0..1*
|*authoriser*: `link:/classes/String[String]`
...
h|*0..1*
|*item_status*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
...
h|*0..1*
|*version_set_id*: `link:/classes/String[String]`
a|Version set id of this item in original system, where applicable.

h|*0..1*
|*system_id*: `link:/classes/String[String]`
...
h|*0..1*
|*item*: `link:/classes/LOCATABLE[LOCATABLE]`
a|Content object.
|===
