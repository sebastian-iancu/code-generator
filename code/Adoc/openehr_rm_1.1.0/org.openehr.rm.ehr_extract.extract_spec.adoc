...
h|*0..1*
|*version_spec*: `link:/classes/EXTRACT_VERSION_SPEC[EXTRACT_VERSION_SPEC]`
...
h|*1..1*
|*manifest*: `link:/classes/EXTRACT_MANIFEST[EXTRACT_MANIFEST]`
a|Specification of entities (e.g. records) to include in the Extract.

h|*1..1*
|*extract_type*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
...
h|*1..1*
|*link_depth*: `link:/classes/Integer[Integer]`
...
h|*0..**
|*criteria*: `link:/classes/List[List]<link:/classes/DV_PARSABLE[DV_PARSABLE]>`
a|Queries specifying the contents of this Extract.

h|*0..1*
|*other_details*: `link:/classes/ITEM_STRUCTURE[ITEM_STRUCTURE]`
