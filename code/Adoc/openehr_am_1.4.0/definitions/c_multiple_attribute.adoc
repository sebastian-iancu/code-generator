...
h|*Inherit*
2+|`xref:AM:aom14:archetype_package.adoc#_c_attribute_class[C_ATTRIBUTE]`
...
h|*1..1*
|*cardinality*: `xref:AM:aom14:archetype_package.adoc#_cardinality_class[CARDINALITY]`
...
h|*0..1*
|*members* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_c_object_class[C_OBJECT]>`
