...
h|*1..1*
|*term_codes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*1..1*
|*constraint_codes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*1..1*
|*parent_archetype*: `xref:AM:aom14:archetype_package.adoc#_archetype_class[ARCHETYPE]`
...
h|*1..1*
|*term_attribute_names*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
a|
...
a_lang: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]`, +
a_code: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
): `xref:AM:aom14:archetype_package.adoc#_archetype_term_class[ARCHETYPE_TERM]` +
 +
...
a_code: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
): `xref:BASE:foundation_types:terminology_package.adoc#_code_phrase_class[CODE_PHRASE]` +
 +
