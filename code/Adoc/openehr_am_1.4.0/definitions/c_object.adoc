...
h|*1..1*
|*occurrences*: `xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]>`
