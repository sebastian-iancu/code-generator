...
h|*Inherit*
2+|`xref:AM:aom14:archetype_package.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT]`
...
h|*1..1*
|*existence*: `xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]>`
...
h|*0..1*
|*children*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_c_object_class[C_OBJECT]>`
