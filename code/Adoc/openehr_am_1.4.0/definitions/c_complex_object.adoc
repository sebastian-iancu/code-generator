...
h|*Inherit*
2+|`xref:AM:aom14:archetype_package.adoc#_c_defined_object_class[C_DEFINED_OBJECT]`
...
h|*0..1*
|*attributes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_c_attribute_class[C_ATTRIBUTE]>`
