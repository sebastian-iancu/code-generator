...
h|*Inherit*
2+|`xref:BASE:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`
...
h|*1..1*
|*definition*: `xref:AM:aom14:archetype_package.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*ontology*: `xref:AM:aom14:archetype_package.adoc#_archetype_ontology_class[ARCHETYPE_ONTOLOGY]`
a|The ontology of the archetype.

h|*0..1*
|*adl_version*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*concept*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*invariants*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_assertion_class[ASSERTION]>`
...
h|*1..1*
|*physical_paths* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*1..1*
|*logical_paths* ( +
lang: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
...
h|*1..1*
|*is_specialised* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
__post-condition__: `Result implies parent_archetype_id /= Void`
a|True if this archetype is a specialisation of another.

h|*1..1*
|*is_valid* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
...
h|*1..1*
|*node_ids_valid* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if every node_id found on a C_OBJECT node is found in ontology.term_codes.

h|*0..1*
|*previous_version* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Version of predecessor archetype of this archetype, if any.

h|*1..1*
|*internal_references_valid* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if every ARCHETYPE_INTERNAL_REF. target_path refers to a legitimate node in the archetype definition.

h|*1..1*
|*constraint_references_valid* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*short_concept_name* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|The short concept name of the archetype extracted from the archetype_id.

h|*1..1*
|*version* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|
