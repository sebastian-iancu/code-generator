...
h|*0..1*
|*millisecond_valdity*: `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]`
a|Validity of millisecond in constrained time.

h|*0..1*
|*timezone_valdity*: `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]`
a|Validity of timezone in constrained date.

h|*0..1*
|*range*: `xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_date_time_class[Iso8601_date_time]>`
...
h|*1..1*
|*validity_is_range* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
