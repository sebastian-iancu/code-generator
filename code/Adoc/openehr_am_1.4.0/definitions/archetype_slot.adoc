...
h|*Inherit*
2+|`xref:AM:aom14:archetype_package.adoc#_c_reference_object_class[C_REFERENCE_OBJECT]`
...
h|*0..1*
|*includes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_assertion_class[ASSERTION]>`
a|List of constraints defining other archetypes that could be included at this point.

h|*0..1*
|*excludes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_assertion_class[ASSERTION]>`
