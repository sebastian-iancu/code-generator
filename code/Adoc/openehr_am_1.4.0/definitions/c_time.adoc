...
h|*0..1*
|*range*: `xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_time_class[Iso8601_time]>`
