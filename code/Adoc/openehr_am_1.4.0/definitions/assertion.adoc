...
h|*0..1*
|*tag*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Expression tag, used for differentiating multiple assertions.

h|*0..1*
|*string_expression*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|String form of expression, in case an expression evaluator taking String expressions is used for evaluation.

h|*1..1*
|*expression*: `xref:AM:aom14:archetype_package.adoc#_expr_item_class[EXPR_ITEM]`
a|Root of expression tree.

h|*0..1*
|*variables*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom14:archetype_package.adoc#_assertion_variable_class[ASSERTION_VARIABLE]>`
