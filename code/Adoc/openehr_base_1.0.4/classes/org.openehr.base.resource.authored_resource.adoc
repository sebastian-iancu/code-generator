...
h|*1..1*
|*original_language*: `link:/classes/Terminology_code[Terminology_code]`
...
h|*0..1*
|*translations*: `link:/classes/Hash[Hash]<String,TRANSLATION_DETAILS>`
...
h|*1..1*
|*current_revision* (): `link:/classes/String[String]` +
 +
