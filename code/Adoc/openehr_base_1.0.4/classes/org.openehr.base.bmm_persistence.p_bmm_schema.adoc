...
h|*Inherit*
2+|`link:/classes/P_BMM_PACKAGE_CONTAINER[P_BMM_PACKAGE_CONTAINER], link:/classes/BMM_SCHEMA[BMM_SCHEMA]`
...
h|*0..**
|*primitive_types*: `link:/classes/List[List]<link:/classes/P_BMM_CLASS[P_BMM_CLASS]>`
a|Primitive type definitions. Persisted attribute.

h|*0..**
|*class_definitions*: `link:/classes/List[List]<link:/classes/P_BMM_CLASS[P_BMM_CLASS]>`
a|Class definitions. Persisted attribute.

h|*0..1*
|*includes*: `link:/classes/Hash[Hash]<String,BMM_INCLUDE_SPEC>`
...
h|*1..1*
|*merge* ( +
other: `link:/classes/P_BMM_SCHEMA[P_BMM_SCHEMA][1]` +
...
h|*1..1*
|*canonical_packages* (): `link:/classes/P_BMM_PACKAGE[P_BMM_PACKAGE]`
