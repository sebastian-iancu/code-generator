...
h|*Inherit*
2+|`link:/classes/UID_BASED_ID[UID_BASED_ID]`
h|*Functions*
^h|*Signature*
^h|*Meaning*

h|*1..1*
|*object_id* (): `link:/classes/UID[UID]`
...
h|*1..1*
|*version_tree_id* (): `link:/classes/VERSION_TREE_ID[VERSION_TREE_ID]`
...
h|*1..1*
|*creating_system_id* (): `link:/classes/UID[UID]`
