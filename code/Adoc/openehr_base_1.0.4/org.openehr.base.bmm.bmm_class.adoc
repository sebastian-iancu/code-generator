...
h|*Inherit*
2+|`link:/classes/BMM_ENTITY[BMM_ENTITY], link:/classes/BMM_MODEL_ELEMENT[BMM_MODEL_ELEMENT]`
...
h|*1..1*
|*package*: `link:/classes/BMM_PACKAGE[BMM_PACKAGE]`
a|Package this class belongs to.

h|*0..1*
|*properties*: `link:/classes/Hash[Hash]<String,BMM_PROPERTY>`
...
h|*0..**
|*immediate_descendants*: `link:/classes/List[List]<link:/classes/BMM_CLASS[BMM_CLASS]>`
...
h|*1..**
|*flat_properties* (): `link:/classes/List[List]<link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/BMM_PROPERTY[BMM_PROPERTY]<BMM_TYPE>>>`
...
h|*1..1 +
(abstract)*
|*type* (): `link:/classes/BMM_DEFINED_TYPE[BMM_DEFINED_TYPE]`
