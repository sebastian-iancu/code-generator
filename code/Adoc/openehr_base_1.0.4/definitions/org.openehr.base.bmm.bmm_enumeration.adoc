...
h|*1..1*
|*underlying_type_name*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]{nbsp}={nbsp}`
...
h|*1..1*
|*name_map* (): `link:/releases/BASE/{base_release}/foundation_types.html#_hash_class[Hash^]<link:/classes/String,String[String,String] >`
