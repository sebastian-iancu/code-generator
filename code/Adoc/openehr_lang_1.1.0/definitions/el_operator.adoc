...
h|*0..1*
|*precedence_overridden*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*0..1*
|*symbol*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*call*: `xref:LANG:bmm:expression_package.adoc#_el_function_call_class[EL_FUNCTION_CALL]`
