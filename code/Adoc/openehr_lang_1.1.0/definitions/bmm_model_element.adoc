...
h|*0..1*
|*documentation*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:overview.adoc#_any_class[Any]>`
...
h|*0..1*
|*extensions*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:overview.adoc#_any_class[Any]>`
...
h|*1..1*
|*is_root_scope* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
