...
h|*0..1*
|*statement*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{base_release}/expression.html#_statement_class[STATEMENT^]>`
