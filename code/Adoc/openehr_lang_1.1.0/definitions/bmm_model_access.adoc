...
h|*0..1*
|*schema_directories*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
a|List of directories where all the schemas loaded here are found.

h|*0..1*
|*all_schemas*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
a|All schemas found and loaded from `_schema_directory_`. Keyed by `_schema_id_`.

h|*0..1*
|*bmm_models*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:LANG:bmm:core_package.adoc#_bmm_model_class[BMM_MODEL]>`
a|Top-level (root) models in use, keyed by `_model_id_`.

h|*0..1*
|*matching_bmm_models*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
a_schema_dirs: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>[1]`, +
a_schema_load_list: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>` +
): `void`
...
h|*1..1*
|*bmm_model* ( +
a_model_key: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
