...
h|*Inherit*
2+|`link:/releases/BASE/{base_release}/expression.html#_expression_class[EXPRESSION^]`
...
h|*1..1*
|*operator*: `link:/releases/AM/{am_release}/aom14.html#_operator_kind_enumeration[OPERATOR_KIND^]`
