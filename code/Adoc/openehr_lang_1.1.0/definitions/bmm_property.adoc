...
h|*0..1*
|*is_composition*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean] +
{default{nbsp}={nbsp}false}`
...
h|*1..1*
|*display_name* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
