...
h|*1..1*
|*condition*: `link:/releases/AM/{am_release}/aom14.html#_assertion_class[ASSERTION^]`
a|Boolean condition that returns True or False when applied to a member of the operand of a `for_all` operator.

h|*1..1*
|*operand*: `link:/releases/BASE/{base_release}/expression.html#_expr_value_ref_class[EXPR_VALUE_REF^]`
