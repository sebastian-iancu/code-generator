...
h|*1..1*
|*value_literal*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*syntax*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
