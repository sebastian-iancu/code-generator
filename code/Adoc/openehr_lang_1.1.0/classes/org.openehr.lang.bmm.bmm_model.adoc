...
h|*0..**
|*class_definitions*: `link:/classes/List[List]<link:/classes/String[String]>`
a|All classes in this model, keyed by type name.

h|*0..**
|*used_models*: `link:/classes/List[List]<link:/classes/BMM_MODEL[BMM_MODEL]>`
...
h|*0..1*
|*modules*: `link:/classes/Hash[Hash]<String,BMM_MODULE>`
a|All classes in this model, keyed by type name.
h|*Functions*
^h|*Signature*
^h|*Meaning*
