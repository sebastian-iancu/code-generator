...
h|*1..1*
|*call*: `link:/classes/EL_FUNCTION_CALL[EL_FUNCTION_CALL]`
...
h|*1..1*
|*operator_definition* (): `link:/classes/BMM_OPERATOR[BMM_OPERATOR]`
a|Operator definition derived from `_definition.operator_definition()_`.

h|*1..1*
|*equivalent_call* (): `link:/classes/EL_FUNCTION_CALL[EL_FUNCTION_CALL]`
