...
h|*Inherit*
2+|`link:/classes/P_BMM_TYPE[P_BMM_TYPE]`
...
h|*0..1*
|*bmm_type*: `link:/classes/BMM_CONTAINER_TYPE[BMM_CONTAINER_TYPE]`
...
h|*1..1*
|*type_ref* (): `link:/classes/P_BMM_BASE_TYPE[P_BMM_BASE_TYPE]`
a|The target type; this converts to the first parameter in `_generic_parameters_` in `BMM_GENERIC_TYPE`. Persisted attribute.
|===
