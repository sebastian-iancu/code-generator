...
h|*Inherit*
2+|`link:/classes/EL_DECISION_TABLE[EL_DECISION_TABLE]`
...
h|*1..**
|*items*: `link:/classes/List[List]<link:/classes/EL_CASE[EL_CASE]<T>>`
a|Members of the chain, equivalent to branches in an if/then/else chain and cases in a case statement.

h|*1..1*
|*test_value*: `link:/classes/EL_VALUE_GENERATOR[EL_VALUE_GENERATOR]`
