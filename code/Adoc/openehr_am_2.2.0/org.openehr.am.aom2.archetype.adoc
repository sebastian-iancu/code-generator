...
h|*0..1*
|*parent_archetype_id*: `link:/classes/String[String]`
...
h|*1..1*
|*archetype_id*: `link:/classes/ARCHETYPE_HRID[ARCHETYPE_HRID]`
...
h|*1..1*
|*terminology*: `link:/classes/ARCHETYPE_TERMINOLOGY[ARCHETYPE_TERMINOLOGY]`
a|The terminology of the archetype.

h|*0..**
|*rules*: `link:/classes/List[List]<link:/classes/STATEMENT[STATEMENT]>`
...
h|*0..1*
|*rm_overlay*: `link:/classes/RM_OVERLAY[RM_OVERLAY]`
a|
h|*Functions*
^h|*Signature*
^h|*Meaning*
