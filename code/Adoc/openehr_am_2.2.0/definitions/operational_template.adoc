...
h|*0..1*
|*component_terminologies*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:AM:aom2:terminology_package.adoc#_archetype_terminology_class[ARCHETYPE_TERMINOLOGY]>`
...
h|*0..1*
|*terminology_extracts*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:AM:aom2:terminology_package.adoc#_archetype_terminology_class[ARCHETYPE_TERMINOLOGY]>`
