...
h|*0..1*
|*parent_archetype_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*definition*: `xref:AM:aom2:constraint_model_package.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]`
...
h|*0..1*
|*rules*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<link:/classes/STATEMENT[STATEMENT] >`
...
h|*0..1*
|*rm_overlay*: `xref:AM:aom2:rm_overlay_package.adoc#_rm_overlay_class[RM_OVERLAY]`
a|
...
h|*1..1*
|*physical_paths* (): `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
): `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
