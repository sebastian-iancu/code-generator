...
h|*0..1*
|*tuples*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:aom2:constraint_model_package.adoc#_c_primitive_tuple_class[C_PRIMITIVE_TUPLE]>`
a|Tuple definitions.

h|*0..1 +
(effected)*
|*members*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:aom2:constraint_model_package.adoc#_c_attribute_class[C_ATTRIBUTE]>`
