...
h|*1..1*
|*is_before*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if the order relationship is ‘before’, if False, it is ‘after’.

h|*1..1*
|*sibling_node_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*is_after* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
