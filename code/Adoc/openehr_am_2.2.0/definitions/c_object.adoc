...
h|*Inherit*
2+|`xref:AM:aom2:constraint_model_package.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT]`
...
h|*1..1*
|*rm_type_name*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Reference model type that this node corresponds to.

h|*0..1*
|*occurrences*: `xref:BASE:foundation_types:interval_package.adoc#_multiplicity_interval_class[Multiplicity_interval]`
...
h|*1..1*
|*node_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*is_deprecated*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this node and by implication all sub-nodes are deprecated for use.

h|*0..1*
|*sibling_order*: `xref:AM:aom2:constraint_model_package.adoc#_sibling_order_class[SIBLING_ORDER]`
...
h|*1..1*
|*effective_occurrences* (): `xref:BASE:foundation_types:interval_package.adoc#_multiplicity_interval_class[Multiplicity_interval]`
a|

h|*1..1 +
(effected)*
|*c_conforms_to* ( +
other: `xref:AM:aom2:constraint_model_package.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT][1]`, +
...
other: `xref:AM:aom2:constraint_model_package.adoc#_c_object_class[C_OBJECT][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1 +
(effected)*
|*is_prohibited* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
