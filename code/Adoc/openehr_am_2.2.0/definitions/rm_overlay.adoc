...
h|*0..1*
|*rm_visibility*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:AM:aom2:rm_overlay_package.adoc#_rm_attribute_visibility_class[RM_ATTRIBUTE_VISIBILITY]>`
