...
h|*Inherit*
2+|`xref:AM:aom2:definitions_package.adoc#_adl_code_definitions_class[ADL_CODE_DEFINITIONS]`
...
h|*0..1*
|*parent*: `xref:AM:aom2:constraint_model_package.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT]`
a|Parent node, except in the case of the top of a tree, i.e. root `C_COMPLEX_OBJECT` of an archetype definition.

h|*0..1*
|*soc_parent*: `xref:AM:aom2:constraint_model_package.adoc#_c_second_order_class[C_SECOND_ORDER]`
a|
...
h|*1..1*
|*has_path* ( +
a_path: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
...
h|*1..1*
|*path* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*is_second_order_constrained* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
...
h|*1..1*
|*is_root* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this node is the root of the tree.

h|*1..1*
|*is_leaf* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
