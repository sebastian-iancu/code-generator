...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom14.html#_archetype_class[ARCHETYPE^]`, `link:/releases/BASE/{base_release}/resource.html#_authored_resource_class[AUTHORED_RESOURCE^]`
