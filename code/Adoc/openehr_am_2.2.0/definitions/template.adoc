...
h|*0..1*
|*overlays*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:aom2:archetype_package.adoc#_template_overlay_class[TEMPLATE_OVERLAY]>`
