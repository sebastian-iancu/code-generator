...
h|*0..1*
|*is_enumerated_type_constraint*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*has_assumed_value* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if there is an assumed value.

h|*1..1*
|*constrained_typename* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
(redefined)*
|*c_conforms_to* ( +
other: `xref:AM:aom2:constraint_model_package.adoc#_c_primitive_object_class[C_PRIMITIVE_OBJECT][1]`, +
