...
h|*1..1 +
(effected)*
|*members*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:aom2:constraint_model_package.adoc#_c_primitive_object_class[C_PRIMITIVE_OBJECT]>`
