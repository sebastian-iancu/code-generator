...
h|*Inherit*
2+|`xref:AM:aom2:constraint_model_package.adoc#_c_primitive_object_class[C_PRIMITIVE_OBJECT]`
...
h|*1..1 +
(effected)*
|*constraint*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1 +
(effected)*
|*assumed_value*: `xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code]`
a|Assumed Terminology code value.

h|*1..1 +
(effected)*
|*default_value*: `xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code]`
a|
...
h|*0..1*
|*value_set_expanded* (): `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*0..1*
|*value_set_substituted* (): `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_uri_class[Uri]>`
...
h|*0..1*
|*value_set_resolved* (): `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code]>`
...
(effected)*
|*valid_value* ( +
a_value: `xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code][1]` +
...
h|*1..1 +
(effected)*
|*prototype_value* (): `xref:BASE:foundation_types:terminology_package.adoc#_terminology_code_class[Terminology_code]`
