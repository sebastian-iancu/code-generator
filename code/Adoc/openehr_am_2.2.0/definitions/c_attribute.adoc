...
h|*1..1*
|*rm_attribute_name*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Reference model attribute within the enclosing type represented by a `C_OBJECT`.

h|*0..1*
|*existence*: `xref:BASE:foundation_types:interval_package.adoc#_multiplicity_interval_class[Multiplicity_interval]`
...
h|*0..1*
|*children*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:aom2:constraint_model_package.adoc#_c_object_class[C_OBJECT]>`
...
h|*0..1*
|*differential_path*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*cardinality*: `xref:BASE:foundation_types:interval_package.adoc#_cardinality_class[Cardinality]`
a|Cardinality constraint of attribute, if a container attribute.

h|*1..1*
|*is_multiple*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*is_mandatory* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
...
h|*1..1*
|*rm_attribute_path* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Path of this attribute with respect to owning `C_OBJECT`, including differential path where applicable.

h|*1..1*
|*is_single* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
