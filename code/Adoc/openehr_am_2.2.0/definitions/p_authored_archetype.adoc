...
h|*Inherit*
2+|`xref:AM:p_aom2:archetype_package.adoc#_p_archetype_class[P_ARCHETYPE]`, `xref:BASE:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`, `xref:AM:p_aom2:archetype_package.adoc#_p_authored_resource_class[P_AUTHORED_RESOURCE]`
...
h|*1..1*
|*rm_release*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*1..1*
|*is_generated*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*other_meta_data*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
a|
|===
