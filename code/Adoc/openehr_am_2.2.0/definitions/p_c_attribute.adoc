...
h|*0..1*
|*existence*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*children*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:AM:p_aom2:constraint_model_package.adoc#_p_c_object_class[P_C_OBJECT]>`
...
h|*0..1*
|*cardinality*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
