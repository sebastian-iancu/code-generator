...
h|*0..1*
|*is_controlled*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this resource is under any kind of change control (even file copying), in which case revision history is created.

h|*0..1*
|*translations*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>`
...
h|*0..1*
|*description*: `xref:BASE:resource_package.adoc#_resource_description_class[RESOURCE_DESCRIPTION]`
a|Description and lifecycle information of the resource.

h|*0..1*
|*uid*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Unique identifier of the family of archetypes having the same interface identifier (same major version).

h|*0..1*
|*annotations*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>>`
