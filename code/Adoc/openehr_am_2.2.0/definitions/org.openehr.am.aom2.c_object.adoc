...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom14.html#_archetype_constraint_class[ARCHETYPE_CONSTRAINT^]`
...
h|*1..1*
|*c_conforms_to* ( +
other: `link:/releases/AM/{am_release}/aom14.html#_archetype_constraint_class[ARCHETYPE_CONSTRAINT^][1]`, +
rmcc: `link:/releases/BASE/{base_release}/foundation_types.html#_function_class[FUNCTION^]<>[1]` +
...
other: `link:/releases/AM/{am_release}/aom14.html#_c_object_class[C_OBJECT^][1]` +
): `link:/releases/BASE/{base_release}/foundation_types.html#_boolean_class[Boolean^]`
