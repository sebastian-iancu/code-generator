...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom14.html#_c_primitive_object_class[C_PRIMITIVE_OBJECT^]`
...
h|*1..1*
|*c_value_conforms_to* ( +
other: `link:/releases/AM/{am_release}/aom14.html#_c_boolean_class[C_BOOLEAN^][1]` +
