...
h|*0..1*
|*component_terminologies*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:AM:p_aom2:terminology_package.adoc#_p_archetype_terminology_class[P_ARCHETYPE_TERMINOLOGY]>`
