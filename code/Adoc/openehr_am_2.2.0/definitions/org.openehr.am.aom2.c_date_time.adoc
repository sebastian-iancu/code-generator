...
h|*0..**
|*constraint*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{base_release}/foundation_types.html#_interval_class[Interval^]<Iso8601_date_time>>`
...
h|*1..1*
|*timezone_validity* (): `link:/releases/BASE/{base_release}/base_types.html#_validity_kind_class[VALIDITY_KIND^]` +
 +
____: ``
...
h|*1..1*
|*millisecond_validity* (): `link:/releases/BASE/{base_release}/base_types.html#_validity_kind_class[VALIDITY_KIND^]`
