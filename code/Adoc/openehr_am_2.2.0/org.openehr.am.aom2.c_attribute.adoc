...
h|*1..1*
|*rm_attribute_name*: `link:/classes/String[String]`
...
h|*0..**
|*children*: `link:/classes/List[List]<link:/classes/C_OBJECT[C_OBJECT]>`
...
h|*0..1*
|*differential_path*: `link:/classes/String[String]`
...
h|*1..1*
|*is_multiple*: `link:/classes/Boolean[Boolean]`
