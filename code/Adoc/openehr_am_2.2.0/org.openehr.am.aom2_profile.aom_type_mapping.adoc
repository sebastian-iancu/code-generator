...
h|*1..1*
|*source_class_name*: `link:/classes/String[String]`
a|Name of the AOM type being mapped to an RM type.

h|*1..1*
|*target_class_name*: `link:/classes/String[String]`
a|Name of the RM type in the mapping.

h|*0..1*
|*property_mappings*: `link:/classes/Hash[Hash]<String,AOM_PROPERTY_MAPPING>`
