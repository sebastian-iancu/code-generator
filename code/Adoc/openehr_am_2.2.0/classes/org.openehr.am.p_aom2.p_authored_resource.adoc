...
h|*0..**
|*translations*: `link:/classes/List[List]<link:/classes/TRANSLATION_DETAILS[TRANSLATION_DETAILS]>`
...
h|*0..1*
|*uid*: `link:/classes/String[String]`
a|Unique identifier of the family of archetypes having the same interface identifier (same major version).

h|*0..1*
|*annotations*: `link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<String,String>>`
