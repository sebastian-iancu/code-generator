...
h|*Inherit*
2+|`link:/classes/C_TEMPORAL[C_TEMPORAL]`
...
h|*0..**
|*constraint*: `link:/classes/List[List]<link:/classes/Interval[Interval]<Iso8601_date_time>>`
...
h|*1..1*
|*timezone_validity* (): `link:/classes/VALIDITY_KIND[VALIDITY_KIND]` +
 +
____: ``
...
h|*1..1*
|*millisecond_validity* (): `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
