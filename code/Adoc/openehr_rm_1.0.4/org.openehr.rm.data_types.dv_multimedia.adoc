...
h|*Inherit*
2+|`link:/classes/DV_ENCAPSULATED[DV_ENCAPSULATED]`
...
h|*0..1*
|*alternate_text*: `link:/classes/String[String]`
a|Text to display in lieu of multimedia display/replay.

h|*0..1*
|*uri*: `link:/classes/DV_URI[DV_URI]`
...
h|*1..1*
|*is_external* (): `link:/classes/Boolean[Boolean]`
