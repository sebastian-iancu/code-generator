...
h|*1..1*
|*persist_in_server*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*0..1*
|*trigger_events*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]>`
