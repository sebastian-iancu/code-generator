...
h|*1..1*
|*most_recent_version* (): `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]` +
 +
__Post__: `Result.is_equal (items.last.version_id.value)`
a|The version id of the most recent item, as a String.

h|*1..1*
|*most_recent_version_time_committed* (): `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]` +
 +
