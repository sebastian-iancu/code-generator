...
h|*Inherit*
2+|`xref:RM:data_structures_package.adoc#_data_structure_class[DATA_STRUCTURE]`
...
h|*0..1*
|*events*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_structures:history_package.adoc#_event_class[EVENT]<T>>`
...
h|*1..1*
|*is_periodic* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
