...
h|*Inherit*
2+|`xref:RM:composition:content_package.adoc#_content_item_class[CONTENT_ITEM]`
...
h|*0..1*
|*other_participations*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:common:generic_package.adoc#_participation_class[PARTICIPATION]>`
...
h|*1..1*
|*subject_is_self* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
