...
h|*0..1*
|*proof*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
a|Proof of attestation.

h|*0..1*
|*items*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:uri_package.adoc#_dv_ehr_uri_class[DV_EHR_URI]>`
...
h|*1..1*
|*is_pending*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
