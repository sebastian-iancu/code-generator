...
h|*0..1*
|*formatting*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*mappings*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:text_package.adoc#_term_mapping_class[TERM_MAPPING]>`
