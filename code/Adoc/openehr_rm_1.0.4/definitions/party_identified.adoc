...
h|*Inherit*
2+|`xref:RM:common:generic_package.adoc#_party_proxy_class[PARTY_PROXY]`
...
h|*0..1*
|*identifiers*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>`
