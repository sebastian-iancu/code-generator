...
h|*1..1*
|*include_multimedia*: `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Indicates whether inline instances of DV_MULTIMEDIA in the source data are included or not.

h|*1..1*
|*priority*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
...
h|*1..1*
|*link_depth*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
...
h|*0..1*
|*criteria*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:encapsulated_package.adoc#_dv_parsable_class[DV_PARSABLE]>`
