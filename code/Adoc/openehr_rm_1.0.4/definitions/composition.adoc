...
h|*0..1*
|*context*: `xref:RM:composition_package.adoc#_event_context_class[EVENT_CONTEXT]`
...
h|*0..1*
|*content*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:composition:content_package.adoc#_content_item_class[CONTENT_ITEM]>`
...
h|*1..1*
|*is_persistent* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
