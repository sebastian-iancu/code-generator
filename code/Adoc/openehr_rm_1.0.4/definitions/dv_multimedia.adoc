...
h|*0..1*
|*alternate_text*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*data*: `xref:BASE:foundation_types:structures_package.adoc#_array_class[Array]<xref:BASE:foundation_types:primitive_types_package.adoc#_octet_class[Octet]>`
...
h|*0..1*
|*integrity_check*: `xref:BASE:foundation_types:structures_package.adoc#_array_class[Array]<xref:BASE:foundation_types:primitive_types_package.adoc#_octet_class[Octet]>`
...
h|*1..1*
|*size*: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer]`
...
h|*1..1*
|*is_external* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*is_inline* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Computed from the value of the data attribute. True if  the  data is stored  in  expanded  form, ie within the EHR itself.

h|*1..1*
|*is_compressed* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|Computed from the value of the `_compression_algorithm_` attribute: True if  the  data is stored in compressed form.

h|*1..1*
|*has_integrity_check* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
