...
h|*Inherit*
2+|`xref:RM:data_types:basic_package.adoc#_data_value_class[DATA_VALUE]`, `xref:BASE:foundation_types:primitive_types_package.adoc#_ordered_class[Ordered]`
...
h|*0..1*
|*other_reference_ranges*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:data_types:quantity_package.adoc#_reference_range_class[REFERENCE_RANGE]<xref:RM:data_types:quantity_package.adoc#_dv_ordered_class[DV_ORDERED]>>`
...
h|*1..1*
|*is_simple* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if this quantity has no reference ranges.

h|*1..1*
|*is_normal* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]` +
 +
...
(abstract)*
|*infix <* ( +
other: `xref:BASE:foundation_types:primitive_types_package.adoc#_ordered_class[Ordered][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|
