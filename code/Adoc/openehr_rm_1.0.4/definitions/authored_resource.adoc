...
h|*0..1*
|*translations*: `xref:BASE:foundation_types:structures_package.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:RM:common:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>`
