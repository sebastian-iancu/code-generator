...
h|*0..1*
|*contributions*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
...
h|*0..1*
|*compositions*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
