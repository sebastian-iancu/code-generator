...
h|*1..1*
|*archetype_node_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
...
h|*0..1*
|*links*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:common:archetyped_package.adoc#_link_class[LINK]>`
...
h|*1..1*
|*is_archetype_root* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
