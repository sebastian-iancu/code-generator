...
h|*1..1*
|*entities*: `xref:BASE:foundation_types:structures_package.adoc#_list_class[List]<xref:RM:ehr_extract:common_package.adoc#_extract_entity_manifest_class[EXTRACT_ENTITY_MANIFEST]>`
