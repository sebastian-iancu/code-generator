...
h|*1..1*
|*match*: `link:/classes/Character[Character]`
...
h|*0..1*
|*purpose*: `link:/classes/DV_CODED_TEXT[DV_CODED_TEXT]`
a|Purpose of the mapping e.g. 'automated data mining', 'billing', 'interoperability'.

h|*1..1*
|*target*: `link:/classes/CODE_PHRASE[CODE_PHRASE]`
...
h|*1..1*
|*narrower* (): `link:/classes/Boolean[Boolean]` +
 +
__Post__: `match = ‘<’ implies Result`
a|The mapping is to a narrower term.

h|*1..1*
|*broader* (): `link:/classes/Boolean[Boolean]` +
 +
__Post__: `match = ‘>’ implies Result`
a|The mapping is to a broader term.

h|*1..1*
|*equivalent* (): `link:/classes/Boolean[Boolean]`
a|The mapping is to an equivalent term.

h|*1..1*
|*unknown* (): `link:/classes/Boolean[Boolean]` +
 +
__Post__: `match = ‘?’ implies Result`
...
h|*1..1*
|*is_valid_match_code* ( +
c: `link:/classes/Character[Character][1]` +
