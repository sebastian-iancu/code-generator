...
h|*1..1*
|*include_all_versions*: `link:/classes/Boolean[Boolean]`
a|True if all versions of each item in the Extract are included.

h|*0..1*
|*commit_time_interval*: `link:/classes/DV_INTERVAL[DV_INTERVAL]<DV_DATE_TIME>`
