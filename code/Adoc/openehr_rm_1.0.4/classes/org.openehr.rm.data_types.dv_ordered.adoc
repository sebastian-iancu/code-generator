...
h|*Inherit*
2+|`link:/classes/DATA_VALUE[DATA_VALUE], link:/classes/Ordered[Ordered]`
...
h|*0..1*
|*normal_status*: `link:/classes/CODE_PHRASE[CODE_PHRASE]`
...
h|*0..1*
|*normal_range*: `link:/classes/DV_INTERVAL[DV_INTERVAL]`
a|Optional normal range.

h|*0..**
|*other_reference_ranges*: `link:/classes/List[List]<link:/classes/REFERENCE_RANGE[REFERENCE_RANGE]<DV_ORDERED>>`
...
h|*1..1*
|*is_simple* (): `link:/classes/Boolean[Boolean]`
