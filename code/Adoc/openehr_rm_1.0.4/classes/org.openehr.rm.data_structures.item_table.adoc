...
h|*0..**
|*rows*: `link:/classes/List[List]<link:/classes/CLUSTER[CLUSTER]>`
...
h|*1..**
|*row_names* (): `link:/classes/List[List]<link:/classes/DV_TEXT[DV_TEXT]>`
a|Return set of row names.

h|*1..**
|*column_names* (): `link:/classes/List[List]<link:/classes/DV_TEXT[DV_TEXT]>`
a|Return set of column names.

h|*1..1*
|*ith_row* ( +
i: `link:/classes/Integer[Integer][1]` +
): `link:/classes/CLUSTER[CLUSTER]`
a|Return i-th row.
