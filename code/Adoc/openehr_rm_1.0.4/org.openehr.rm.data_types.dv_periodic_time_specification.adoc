...
h|*Inherit*
2+|`link:/classes/DV_TIME_SPECIFICATION[DV_TIME_SPECIFICATION]`
h|*Functions*
^h|*Signature*
^h|*Meaning*
...
h|*1..1*
|*calendar_alignment* (): `link:/classes/String[String]`
a|Calendar alignment extracted from value.

h|*1..1*
|*event_alignment* (): `link:/classes/String[String]`
a|Event alignment extracted from value.

h|*1..1*
|*institution_specified* (): `link:/classes/Boolean[Boolean]`
