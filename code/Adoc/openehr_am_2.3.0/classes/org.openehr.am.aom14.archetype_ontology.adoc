...
h|*1..**
|*term_codes*: `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..**
|*constraint_codes*: `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..1*
|*parent_archetype*: `link:/classes/ARCHETYPE[ARCHETYPE]`
...
h|*1..**
|*term_attribute_names*: `link:/classes/List[List]<link:/classes/String[String]>`
a|
h|*Functions*
^h|*Signature*
^h|*Meaning*
