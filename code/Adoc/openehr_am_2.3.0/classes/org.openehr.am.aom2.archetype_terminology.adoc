...
h|*1..1*
|*is_differential*: `link:/classes/Boolean[Boolean]`
...
h|*1..1*
|*original_language*: `link:/classes/String[String]`
...
h|*1..1*
|*concept_code*: `link:/classes/String[String]`
...
h|*1..1*
|*term_definitions*: `link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<String,ARCHETYPE_TERM>>`
...
h|*0..1*
|*term_bindings*: `link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<String,Uri>>`
...
h|*1..1*
|*owner_archetype*: `link:/classes/ARCHETYPE[ARCHETYPE]`
a|Archetype that owns this terminology.

h|*0..**
|*value_sets*: `link:/classes/List[List]<link:/classes/String[String]>`
a|Archetype-local value sets, each keyed by value-set id, i.e. an ac-code.

h|*0..1*
|*terminology_extracts*: `link:/classes/Hash[Hash]<link:/classes/String[String],link:/classes/Hash[Hash]<String,ARCHETYPE_TERM>>`
...
h|*1..**
|*id_codes* (): `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..**
|*value_codes* (): `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..**
|*value_set_codes* (): `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..1*
|*has_terminology* ( +
a_terminology_id: `link:/classes/String[String][1]` +
): `link:/classes/Boolean[Boolean]`
...
a_lang: `link:/classes/String[String][1]`, +
a_code: `link:/classes/String[String][1]` +
): `link:/classes/ARCHETYPE_TERM[ARCHETYPE_TERM]` +
 +
...
h|*1..1*
|*term_binding* ( +
a_terminology: `link:/classes/String[String][1]`, +
a_code: `link:/classes/String[String][1]` +
): `link:/classes/Uri[Uri]` +
 +
...
h|*1..**
|*terminologies_available* (): `link:/classes/List[List]<link:/classes/String[String]>`
...
h|*1..**
|*languages_available* (): `link:/classes/List[List]<link:/classes/String[String]>`
