...
h|*0..1*
|*month_validity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of month in constrained date.

h|*0..1*
|*day_validity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of day in constrained date.

h|*0..1*
|*hour_validity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of hour in constrained time.

h|*0..1*
|*minute_validity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of minute in constrained time.

h|*0..1*
|*second_validity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of second in constrained time.

h|*0..1*
|*millisecond_valdity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of millisecond in constrained time.

h|*0..1*
|*timezone_valdity*: `link:/classes/VALIDITY_KIND[VALIDITY_KIND]`
a|Validity of timezone in constrained date.

h|*0..1*
|*range*: `link:/classes/Interval[Interval]<Iso8601_date_time>`
a|Range of Date_times specifying constraint.

h|*0..1*
|*assumed_value*: `link:/classes/Iso8601_date_time[Iso8601_date_time]`
...
h|*1..1*
|*validity_is_range* (): `link:/classes/Boolean[Boolean]`
