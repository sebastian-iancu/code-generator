...
h|*1..1*
|*codes_conformant* ( +
a_child_code: `link:/classes/String[String][1]`, +
a_parent_code: `link:/classes/String[String][1]` +
...
a-code: `link:/classes/String[String][1]`, +
a_level: `link:/classes/Integer[Integer][1]` +
): `link:/classes/Boolean[Boolean]`
