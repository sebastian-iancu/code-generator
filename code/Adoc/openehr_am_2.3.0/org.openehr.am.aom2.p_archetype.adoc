...
h|*1..1*
|*archetype_id*: `link:/classes/P_ARCHETYPE_HRID[P_ARCHETYPE_HRID]`
...
h|*1..1*
|*definition*: `link:/classes/P_C_COMPLEX_OBJECT[P_C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*terminology*: `link:/classes/P_ARCHETYPE_TERMINOLOGY[P_ARCHETYPE_TERMINOLOGY]`
a|The terminology of the archetype.

h|*0..**
|*rules*: `link:/classes/List[List]<link:/classes/EL_BOOLEAN_EXPRESSION[EL_BOOLEAN_EXPRESSION]>`
