...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/p_aom2.html#_p_archetype_class[P_ARCHETYPE^], link:/releases/BASE/{base_release}/resource.html#_authored_resource_class[AUTHORED_RESOURCE^], link:/releases/AM/{am_release}/p_aom2.html#_p_authored_resource_class[P_AUTHORED_RESOURCE^]`
...
h|*1..1*
|*other_meta_data*: `link:/releases/BASE/{base_release}/foundation_types.html#_hash_class[Hash^]<String,String>`
a|
|===
