...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom2.html#_c_defined_object_class[C_DEFINED_OBJECT^]`
...
h|*0..**
|*attributes*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/aom2.html#_c_attribute_class[C_ATTRIBUTE^]>`
