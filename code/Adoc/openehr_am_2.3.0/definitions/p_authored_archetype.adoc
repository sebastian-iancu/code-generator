...
h|*Inherit*
2+|`xref:AM:aom2:persistence_package.adoc#_p_archetype_class[P_ARCHETYPE]`, `xref:BASE:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`, `xref:AM:aom2:persistence_package.adoc#_p_authored_resource_class[P_AUTHORED_RESOURCE]`
...
h|*1..1*
|*other_meta_data*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String],xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
a|
|===
