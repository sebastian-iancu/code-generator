...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/p_aom2.html#_p_archetype_constraint_class[P_ARCHETYPE_CONSTRAINT^]`
...
h|*0..**
|*children*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/p_aom2.html#_p_c_object_class[P_C_OBJECT^]>`
