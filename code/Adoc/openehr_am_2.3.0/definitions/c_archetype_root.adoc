...
h|*Inherit*
2+|`xref:AM:aom2:constraint_model_package.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]`
...
h|*1..1*
|*archetype_ref*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]`
