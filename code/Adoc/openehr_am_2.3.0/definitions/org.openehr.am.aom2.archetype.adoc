...
h|*1..1*
|*ontology*: `link:/releases/AM/{am_release}/aom14.html#_archetype_ontology_class[ARCHETYPE_ONTOLOGY^]`
...
h|*0..**
|*invariants*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/aom14.html#_assertion_class[ASSERTION^]>`
