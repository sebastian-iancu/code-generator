...
h|*1..1*
|*Id_code_leader*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"id"`
a|String leader of ‘identifier’ codes, i.e. codes used to identify archetype nodes.

h|*1..1*
|*Value_code_leader*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"at"`
a|String leader of ‘value’ codes, i.e. codes used to identify codes values, including value set members.

h|*1..1*
|*Value_set_code_leader*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"ac"`
a|String leader of ‘value set’ codes, i.e. codes used to identify value sets.

h|*1..1*
|*Specialisation_separator*: `xref:BASE:foundation_types:primitive_types_package.adoc#_character_class[Character]{nbsp}={nbsp}'.'`
a|Character used to separate numeric parts of codes belonging to different specialisation levels.

h|*1..1*
|*Code_regex_pattern*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"(0|[1-9][0-9]*)(\.(0|[1-9][0-9]*))*"`
...
h|*1..1*
|*Root_code_regex_pattern*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"^id1(\.1)*$"`
a|Regex pattern of the root id code of any archetype. Corresponds to codes of the form `id1`, `id1.1`, `id1.1.1` etc..

h|*1..1*
|*Primitive_node_id*: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]{nbsp}={nbsp}"id9999"`
...
h|*1..1*
|*codes_conformant* ( +
a_child_code: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]`, +
a_parent_code: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
...
a-code: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]`, +
a_level: `xref:BASE:foundation_types:primitive_types_package.adoc#_integer_class[Integer][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
