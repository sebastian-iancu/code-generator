...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom14.html#_c_defined_object_class[C_DEFINED_OBJECT^]`
...
h|*0..1*
|*attributes*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/aom14.html#_c_attribute_class[C_ATTRIBUTE^]>`
...
h|*1..1*
|*c_conforms_to* ( +
other: `link:/releases/AM/{am_release}/aom14.html#_c_complex_object_class[C_COMPLEX_OBJECT^][1]`, +
