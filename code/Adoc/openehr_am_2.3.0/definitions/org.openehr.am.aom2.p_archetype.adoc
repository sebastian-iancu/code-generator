...
h|*1..1*
|*archetype_id*: `link:/releases/AM/{am_release}/p_aom2.html#_p_archetype_hrid_class[P_ARCHETYPE_HRID^]`
...
h|*1..1*
|*definition*: `link:/releases/AM/{am_release}/p_aom2.html#_p_c_complex_object_class[P_C_COMPLEX_OBJECT^]`
a|Root node of the definition of this archetype.

h|*1..1*
|*terminology*: `link:/releases/AM/{am_release}/p_aom2.html#_p_archetype_terminology_class[P_ARCHETYPE_TERMINOLOGY^]`
