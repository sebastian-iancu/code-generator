...
h|*1..1 +
(effected)*
|*members*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/aom14.html#_c_primitive_object_class[C_PRIMITIVE_OBJECT^]>`
