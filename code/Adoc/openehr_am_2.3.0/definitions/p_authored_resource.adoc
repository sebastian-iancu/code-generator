...
h|*0..1*
|*translations*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>`
