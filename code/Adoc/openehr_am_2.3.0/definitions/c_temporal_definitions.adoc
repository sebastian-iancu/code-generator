...
h|*1..1*
|*valid_date_constraint_patterns*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*1..1*
|*valid_time_constraint_patterns*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
h|*1..1*
|*valid_date_time_constraint_patterns*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String]>`
...
a_dur: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]`, +
other_dur: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
