...
h|*Inherit*
2+|`xref:AM:aom2:constraint_model_package.adoc#_c_temporal_class[C_TEMPORAL]`
...
h|*0..1 +
(effected)*
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval_package.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_duration_class[Iso8601_duration]>>`
...
h|*1..1*
|*years_allowed:* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if years are allowed in the constrained Duration.

h|*1..1*
|*months_allowed:* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if months are allowed in the constrained Duration.

h|*1..1*
|*weeks_allowed:* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if weeks are allowed in the constrained Duration.

h|*1..1*
|*days_allowed* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if days are allowed in the constrained Duration.

h|*1..1*
|*hours_allowed* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if hours are allowed in the constrained Duration.

h|*1..1*
|*minutes_allowed* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if minutes are allowed in the constrained Duration.

h|*1..1*
|*seconds_allowed* (): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
a|True if seconds are allowed in the constrained Duration.

h|*1..1 +
(effected)*
|*valid_pattern_constraint* ( +
a_pattern: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
...
a_pattern: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]`, +
an_other_pattern: `xref:BASE:foundation_types:primitive_types_package.adoc#_string_class[String][1]` +
): `xref:BASE:foundation_types:primitive_types_package.adoc#_boolean_class[Boolean]`
