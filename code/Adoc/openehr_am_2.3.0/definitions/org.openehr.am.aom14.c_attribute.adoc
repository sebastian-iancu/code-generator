...
h|*Inherit*
2+|`link:/releases/AM/{am_release}/aom2.html#_archetype_constraint_class[ARCHETYPE_CONSTRAINT^]`
...
h|*1..1*
|*existence*: `link:/releases/BASE/{base_release}/foundation_types.html#_interval_class[Interval^]<Integer>`
...
h|*0..**
|*children*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/AM/{am_release}/aom2.html#_c_object_class[C_OBJECT^]>`
